...
export default Vue.extend({
  ...
  methods: {
    ...
    async addCategory(): Promise<boolean> {
      return this.$store.dispatch('database/categories/hookah/corkage-fees/add', this.formData);
    },
    async editCategory(): Promise<boolean> {
      return this.$store.dispatch('database/categories/hookah/corkage-fees/update', this.formData);
    },
    async removeCategory(id): Promise<boolean> {
      return this.$store.dispatch('database/categories/hookah/corkage-fees/remove', id);
    },
    async moveCategory({ newPos, el }): Promise<boolean> {
      return this.$store.dispatch('database/categories/hookah/corkage-fees/move', { newPos, el });
    },
