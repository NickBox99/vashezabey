...
export default Vue.extend({
  ...
  methods: {
    ...
    async addCategory(): Promise<boolean> {
      return this.$store.dispatch('database/categories/hookah/fruity/add', this.formData);
    },
    async editCategory(): Promise<boolean> {
      return this.$store.dispatch('database/categories/hookah/fruity/update', this.formData);
    },
    async removeCategory(id): Promise<boolean> {
      return this.$store.dispatch('database/categories/hookah/fruity/remove', id);
    },
    async moveCategory({ newPos, el }): Promise<boolean> {
      return this.$store.dispatch('database/categories/hookah/fruity/move', { newPos, el });
    },
