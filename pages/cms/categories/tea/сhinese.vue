...
export default Vue.extend({
  ...
  methods: {
    ...
    async addCategory(): Promise<boolean> {
      return this.$store.dispatch('database/categories/tea/сhinese/add', this.formData);
    },
    async editCategory(): Promise<boolean> {
      return this.$store.dispatch('database/categories/tea/сhinese/update', this.formData);
    },
    async removeCategory(id): Promise<boolean> {
      return this.$store.dispatch('database/categories/tea/сhinese/remove', id);
    },
    async moveCategory({ newPos, el }): Promise<boolean> {
      return this.$store.dispatch('database/categories/tea/сhinese/move', { newPos, el });
    },
