...
export default Vue.extend({
  ...
  methods: {
    ...
    async addCategory(): Promise<boolean> {
      return this.$store.dispatch('database/categories/tea/not-teas/add', this.formData);
    },
    async editCategory(): Promise<boolean> {
      return this.$store.dispatch('database/categories/tea/not-teas/update', this.formData);
    },
    async removeCategory(id): Promise<boolean> {
      return this.$store.dispatch('database/categories/tea/not-teas/remove', id);
    },
    async moveCategory({ newPos, el }): Promise<boolean> {
      return this.$store.dispatch('database/categories/tea/not-teas/move', { newPos, el });
    },
