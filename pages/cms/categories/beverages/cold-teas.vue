...
export default Vue.extend({
  name: "cms-categories-beverages-cold-teas",
  layout: 'cms',
  async asyncData({ store }) {
    await store.dispatch('database/categories/beverages/cold-teas/getAll');
  },
  data() {
    return {
      formData: {
  ...
  methods: {
    ...
    textToHtmlText,
    async addCategory() {
      return await this.$store.dispatch('database/categories/beverages/cold-teas/add', this.formData);
    },
    async editCategory() {
      return await this.$store.dispatch('database/categories/beverages/cold-teas/update', this.formData);
    },
    async removeCategory(id) {
      await this.$store.dispatch('database/categories/beverages/cold-teas/remove', id);
    },
    async moveCategory({ newPos, el }) {
      await this.$store.dispatch('database/categories/beverages/cold-teas/move', { newPos, el });
    },
  ...
  computed: {
    ...mapGetters({
      categories: 'database/categories/beverages/cold-teas/getAll'
    })
  }
})
</script>
