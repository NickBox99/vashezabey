...
export default {
  async getAll({ dispatch }: Database.IStore): Promise<Database.ICategory[]> {
    return dispatch('cache/getUseCache', { key: 'categories-tea-сlassic', fetchCallback: () => Vue.prototype.$fb.categories.tea.сlassic.getAll() }, { root: true })
  },
  ...
  async add({ commit }: Database.IStore, category: Database.ICategory) {
    commit('cache/add', { key: 'categories-tea-сlassic', value: await Vue.prototype.$fb.categories.tea.сlassic.add(category) }, { root: true });
  },
  ...
  async update({ commit, dispatch }: Database.IStore, category: Database.ICategory) {
    ...
    commit('cache/update', { key: 'categories-tea-сlassic', value: newCategory}, { root: true });
    Vue.prototype.$fb.categories.tea.сlassic.update(newCategory);
    return true;
  },

  async remove({ commit }: Database.IStore, id: string) {
    await Vue.prototype.$fb.categories.tea.сlassic.remove(id);
    commit('cache/remove', { key: 'categories-tea-сlassic', id }, { root: true });
  },
